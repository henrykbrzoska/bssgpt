...
class Bssgpt extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Hbrzoska');
        $this->description = $this->l('test test testtest test testtest test testtest test testtest test test');
    ...
    {
        Configuration::updateValue('GPTTITLE_LIVE_MODE', false);
    ...
    {
        Configuration::deleteByName('GPTTITLE_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitBssGptModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitBssGptModule';
    ...
    {
        return array(
            'GPTTITLE_LIVE_MODE' => Configuration::get('GPTTITLE_LIVE_MODE', true),
            'GPTTITLE_API_KEY' => Configuration::get('GPTTITLE_API_KEY', null),
        );
    }
